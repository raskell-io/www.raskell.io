...
[extra]
author = "Raffael"
image = "notes-from-rsac-2026.avif"
og_image = "notes-from-rsac-2026.png"
+++
...
This is also, incidentally, part of why I built [Zentinel](https://zentinelproxy.io/) the way I did. A reverse proxy that sits at the edge, where policy enforcement happens at wire speed, is exactly the kind of system that needs to operate autonomously within human-defined constraints. The agent architecture in Zentinel, where security logic runs in isolated processes with bounded resources and explicit failure modes, is my answer to the question of how you let autonomous systems make real-time decisions while keeping the human in the position of supervisor rather than bottleneck. I wrote about this in more detail in [What Zentinel Is Really Optimizing For](/articles/what-zentinel-is-really-optimizing-for/).
...
- [RSAC 2026](https://www.rsaconference.com/) - The conference itself
- [AI 2027](https://ai-2027.com/) - Scenario work by Kokotajlo, Alexander, Larsen, Lifland, and Dean
- [How I Work These Days](/articles/how-i-work-these-days/) - Where I first wrote about AI 2027 and the shift in how I build
- [What Zentinel Is Really Optimizing For](/articles/what-zentinel-is-really-optimizing-for/) - The design philosophy behind Zentinel and why agent isolation matters
- [Zentinel](https://zentinelproxy.io/) - The security-first reverse proxy I built on Pingora
- [Archipelag](https://archipelag.io/) - Decentralized, sovereignty-first AI compute network
- [Die Zukunft](https://die-zukunft.ch/) - Swiss political party for structural transformation

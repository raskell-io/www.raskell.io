...
<section class="slide slide--end">
  <div class="slide__inner">
    ...
    <p class="slide__byline">
      <a href="https://raskell.io">raskell.io</a> ·
      <a href="https://ch.linkedin.com/in/raffael-e-schneider">LinkedIn</a> ·
      <a href="https://twitter.com/raskelll">@raskelll</a>
    </p>
    <ul class="slide__qrs" aria-label="Scan to follow">
      <li>
        <a href="https://raskell.io" aria-label="raskell.io">
          <img class="slide__qr" src="/talks/iat-13-basel/qr-raskell.svg" alt="QR code for raskell.io" width="96" height="96">
        </a>
        <span class="slide__qr-label">
          <img class="slide__qr-icon slide__qr-icon--img" src="/raskell-mascot.avif" alt="" width="20" height="20">
          raskell.io
        </span>
      </li>
      <li>
        <a href="https://ch.linkedin.com/in/raffael-e-schneider" aria-label="LinkedIn profile">
          <img class="slide__qr" src="/talks/iat-13-basel/qr-linkedin.svg" alt="QR code for LinkedIn profile" width="96" height="96">
        </a>
        <span class="slide__qr-label">
      ...
      <li>
        <a href="https://twitter.com/raskelll" aria-label="X/Twitter profile">
          <img class="slide__qr" src="/talks/iat-13-basel/qr-twitter.svg" alt="QR code for X/Twitter profile" width="96" height="96">
        </a>
        <span class="slide__qr-label">
          <svg class="slide__qr-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          @raskelll
        </span>
      </li>
    </ul>
